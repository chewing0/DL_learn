...
from RNN_dataloader import TextDeal, SeqDataLoader
...
# 实现一个类来包装上述函数，并存储从零开始实现的循环神经网络模型的参数
...
if __name__ == '__main__':
    ...
    data_iter = SeqDataLoader(corpus, batch_size=32, num_steps=40, use_random_iter=True)
    ...
    train_ch8(net, data_iter, vocab, lr, num_epochs, device, use_random_iter=True)